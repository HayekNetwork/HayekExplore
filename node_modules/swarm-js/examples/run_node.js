...
// To run Swarm locally, you need a running Ghyk
// node and an Hayekchain account/password
const swarmSetup = {
  privateKey: privateKeyPath,
  dataDir: process.env.HOME + "/Library/Hayekchain/testnet",
  ensApi: process.env.HOME + "/Library/Hayekchain/testnet/ghyk.ipc",
