...
// Downloads list of Ghyk releases
console.log("Retrieving list of Ghyk releases from https://ghykstore.blob.core.windows.net.");
got("https://ghykstore.blob.core.windows.net/builds?restype=container&comp=list")
  ...
  .then(blobs => {
    ...
    return blobs
      ...
      .map((file) => {
        const ghykArchiveName = file.Name[0];
        const parts = ghykArchiveName.split("-");
        ...
        return {
          ...
          arch: parts[3],
          version: parts[4],
          ghykArchiveName: ghykArchiveName,
          ghykArchivePath: path.join(process.cwd(), "tmp_downloads", ghykArchiveName),
          ghykArchiveUrl: "https://ghykstore.blob.core.windows.net/builds/" + ghykArchiveName,
          ghykFilesPath: path.join(process.cwd(), "tmp_downloads", ghykArchiveName.replace(/(\.zip|\.tar\.gz)/,"")),
  ...
  .then(binaries => {
    ...
    return Q.all(binaries
      ...
      .map(bin => {
        ...
        console.log("Downloading " + bin.ghykArchivePath + ".");
        return files.download(bin.ghykArchiveUrl)(bin.ghykArchivePath)
          ...
          .then(() => files.search(/swarm(.exe|)$/)(bin.ghykFilesPath))
