...
console.log("Benchmarking Hyk-Lib's RLP implementation vs the one on NPM.");
...
console.log("- Hyk-Lib: " + liteCps + " calls per second.");
console.log("- Reference: " + npmCps + " calls per second.");
console.log("- Hyk-Lib is: " + (liteCps / npmCps).toFixed(2) + " " + (liteCps > npmCps ? "faster" : "slower") + " than reference.");
