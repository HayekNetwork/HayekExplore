...
// HayekchainRPC, IncompleteTransaction -> Promise Transaction
var addDefaults = function addDefaults(rpc, tx) {
  var baseDefaults = [tx.chainId || rpc("net_version", []), tx.gasPrice || rpc("hyk_gasPrice", []), tx.nonce || rpc("hyk_getTransactionCount", [tx.from, "latest"]), tx.value || "0x0", tx.data || "0x"];
  ...
  return Promise.all(baseDefaults).then(function (_ref) {
    ...
    var gasEstimator = tx.gas ? Promise.resolve(null) : rpc("hyk_estimateGas", [{
