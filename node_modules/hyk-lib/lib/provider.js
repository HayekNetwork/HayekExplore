...
var HayekchainProvider = function HayekchainProvider(url, intercept) {
  ...
  if (/^ws/.test(url)) {
    ...
    ws.on("open", function () {
      return callbacks.connect && callbacks.connect(hyk);
    });
    ...
    api.send = makeSender(function (method, params, callback) {
      request(url, {
        ...
        return callback("Couldn't connect to Hayekchain node.");
      });
    });
...
module.exports = HayekchainProvider;