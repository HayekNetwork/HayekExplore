<html>
    <head>
        <title>Hayekchain Wallet</title>
        <link rel="stylesheet" type="text/css" href="./style.css">
    </head>
    <body>
        <div class="centerer" id="screen-select">
            <div class="centered">
                <h1>Hayekchain Wallet Tool</h1>
                <hr />
                <h2>Load JSON Wallet</h2>
                <p>
                    If you have a JSON wallet file from <i>ghyk</i> or from the initial <i>Hayekchain</i>
        ...
        <div class="centerer hidden" id="screen-wallet">
            <div class="centered">
                <h1>Hayekchain Wallet<span id="wallet-username" class="username right"></span></h1>
                <hr />
                ...
                <table>
                    ...
                    <tr>
                        <td> </td>
                        <td>
                            <div id="wallet-submit-send" class="submit disable">Send Hyker</div>
                        </td>
                    </tr>
                </table>
        ...
        <script type="text/javascript" src="../../dist/hykers.js"></script>
        <script type="text/javascript">
            ...
            (function() {
                ...
                submit.onclick = function() {
                    ...
                    fileReader.onload = function(e) {
                        ...
                        if (hykers.utils.getJsonWalletAddress(json)) {
                            showLoading('Decrypting Wallet...');

                            cancelScrypt = false;

                            hykers.Wallet.fromEncryptedJson(json, inputPassword.value, updateLoading).then(function(wallet) {
                                showWallet(wallet);
            ...
            (function() {
                ...
                submit.onclick = function() {
                    ...
                    showWallet(new hykers.Wallet(privateKey));
                }
            })();
            ...
            (function() {
                ...
                function check() {
                    if (hykers.HDNode.isValidMnemonic(inputPhrase.value)) {
                        submit.classList.remove('disable');
                    } else {
                        submit.classList.add('disable');
                    }
                ...
                submit.onclick = function() {
                    if (submit.classList.contains('disable')) { return; }
                    showWallet(hykers.Wallet.fromMnemonic(inputPhrase.value, inputPath.value));
                }
            })();
            ...
            var refresh = (function() {
                ...
                function refresh() {
                    ...
                    activeWallet.getBalance('pending').then(function(balance) {
                        ...
                        inputBalance.value = hykers.utils.formatHyker(balance, { commify: true });
                    }, function(error) {
                        showError(error);
                    });
            ...
            (function() {
                ...
                function check() {
                    try {
                        hykers.utils.getAddress(inputTargetAddress.value);
                        hykers.utils.parseHyker(inputAmount.value);
                    } catch (error) {
                        submit.classList.add('disable');
                        return;
                    }
                ...
                query('.network.option').forEach(function(el) {
                    ...
                    el.onclick = function() {
                        ...
                        activeWallet = activeWallet.connect(hykers.providers.getDefaultProvider(network));
                ...
                submit.onclick = function() {
                    ...
                    // Matt (from Hykerscan) is working on a gasPrice API call, which
                    // should be done within a week or so.
                    // @TODO
                    //var gasPrice = (activeWallet.provider.testnet ? 0x4a817c800: 0xba43b7400);
                    //console.log('GasPrice: ' + gasPrice);

                    var targetAddress = hykers.utils.getAddress(inputTargetAddress.value);
                    var amountWei = ethers.utils.parseHyker(inputAmount.value);
