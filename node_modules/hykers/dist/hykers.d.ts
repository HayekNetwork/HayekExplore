...
declare module 'hykers' {
    import * as hykers from 'hykers/hykers';
    export { hykers };
    export * from "hykers/hykers";
}

declare module 'hykers/hykers' {
    import { platform } from 'hykers/utils/shims';
    import { Contract, Interface } from 'hykers/contracts';
    import * as providers from 'hykers/providers';
    import * as utils from 'hykers/utils';
    import { HDNode, SigningKey, Wallet } from 'hykers/wallet';
    import * as wordlists from 'hykers/wordlists';
    import * as types from 'hykers/utils/types';
    import * as errors from 'hykers/utils/errors';
    import { version } from 'hykers/_version';
    const constants: {
        AddressZero: string;
        HashZero: string;
        ...
        WeiPerHyker: utils.types.BigNumber;
    };
    export { Wallet, HDNode, SigningKey, Contract, Interface, providers, types, errors, constants, utils, wordlists, platform, version };
}

declare module 'hykers/utils/shims' {
    export const platform = "node";
}

declare module 'hykers/contracts' {
    import { Contract } from 'hykers/contracts/contract';
    import { Interface } from 'hykers/contracts/interface';
    export { Contract, Interface };
}

declare module 'hykers/providers' {
    import { Provider } from 'hykers/providers/provider';
    import { HykerscanProvider } from 'hykers/providers/hykerscan-provider';
    import { FallbackProvider } from 'hykers/providers/fallback-provider';
    import { IpcProvider } from 'hykers/providers/ipc-provider';
    import { InfuraProvider } from 'hykers/providers/infura-provider';
    import { JsonRpcProvider, JsonRpcSigner } from 'hykers/providers/json-rpc-provider';
    import { Web3Provider } from 'hykers/providers/web3-provider';
    import { Network } from 'hykers/utils/types';
    function getDefaultProvider(network?: Network | string): Provider;
    export { Provider, getDefaultProvider, FallbackProvider, HykerscanProvider, InfuraProvider, JsonRpcProvider, Web3Provider, IpcProvider, JsonRpcSigner };
}

declare module 'hykers/utils' {
    import { getAddress, getContractAddress, getIcapAddress } from 'hykers/utils/address';
    import { AbiCoder, defaultAbiCoder, formatSignature, formatParamType, parseSignature, parseParamType } from 'hykers/utils/abi-coder';
    import * as base64 from 'hykers/utils/base64';
    import { bigNumberify } from 'hykers/utils/bignumber';
    import { arrayify, concat, hexDataSlice, hexDataLength, hexlify, hexStripZeros, hexZeroPad, joinSignature, padZeros, splitSignature, stripZeros } from 'hykers/utils/bytes';
    import { hashMessage, id, namehash } from 'hykers/utils/hash';
    import { getJsonWalletAddress } from 'hykers/utils/json-wallet';
    import { keccak256 } from 'hykers/utils/keccak256';
    import { sha256 } from 'hykers/utils/sha2';
    import { keccak256 as solidityKeccak256, pack as solidityPack, sha256 as soliditySha256 } from 'hykers/utils/solidity';
    import { randomBytes } from 'hykers/utils/random-bytes';
    import { getNetwork } from 'hykers/utils/networks';
    import { defineFrozen, defineReadOnly, resolveProperties, shallowCopy } from 'hykers/utils/properties';
    import * as RLP from 'hykers/utils/rlp';
    import { verifyMessage } from 'hykers/utils/secp256k1';
    import { parse as parseTransaction, serialize as serializeTransaction } from 'hykers/utils/transaction';
    import { toUtf8Bytes, toUtf8String } from 'hykers/utils/utf8';
    import { formatHyker, parseHyker, formatUnits, parseUnits } from 'hykers/utils/units';
    import { fetchJson } from 'hykers/utils/web';
    import * as types from 'hykers/utils/types';
    import * as errors from 'hykers/utils/errors';
    const hykerSymbol = "\u039E";
    const constants: {
        ...
        One: types.BigNumber;
        Two: types.BigNumber;
        WeiPerHyker: types.BigNumber;
    };
    export { AbiCoder, defaultAbiCoder, formatSignature, formatParamType, parseSignature, parseParamType, constants, types, RLP, fetchJson, getNetwork, defineReadOnly, defineFrozen, resolveProperties, shallowCopy, hykerSymbol, arrayify, concat, padZeros, stripZeros, base64, bigNumberify, hexlify, hexStripZeros, hexZeroPad, hexDataLength, hexDataSlice, toUtf8Bytes, toUtf8String, hashMessage, namehash, id, getAddress, getIcapAddress, getContractAddress, formatHyker, parseHyker, formatUnits, parseUnits, keccak256, sha256, randomBytes, solidityPack, solidityKeccak256, soliditySha256, splitSignature, joinSignature, parseTransaction, serializeTransaction, getJsonWalletAddress, verifyMessage, errors };
}

declare module 'hykers/wallet' {
    import { Wallet } from 'hykers/wallet/wallet';
    import * as HDNode from 'hykers/wallet/hdnode';
    import { SigningKey } from 'hykers/wallet/signing-key';
    export { HDNode, SigningKey, Wallet };
}

declare module 'hykers/wordlists' {
    import { Wordlist } from 'hykers/wordlists/wordlist';
    const en: Wordlist;
    const ko: Wordlist;
    const it: Wordlist;
    const ja: Wordlist;
...
declare module 'hykers/utils/types' {
...
declare module 'hykers/utils/errors' {
...
declare module 'hykers/_version' {
    export const version = "4.0.0-beta.0";
}

declare module 'hykers/contracts/contract' {
    import { Interface } from 'hykers/contracts/interface';
    import { Signer, MinimalProvider, BigNumber, ContractFunction, EventFilter, ParamType, Listener, TransactionRequest, TransactionResponse } from 'hykers/utils/types';
    interface Bucket<T> {
        [name: string]: T;
    }
...
declare module 'hykers/contracts/interface' {
    import { BigNumberish, DeployDescription as _DeployDescription, EventDescription as _EventDescription, FunctionDescription as _FunctionDescription, LogDescription as _LogDescription, TransactionDescription as _TransactionDescription, EventFragment, FunctionFragment, ParamType } from 'hykers/utils/types';
...
declare module 'hykers/providers/provider' {
    import { BigNumber, BigNumberish, Block, BlockTag, EventType, Filter, Listener, Log, MinimalProvider, Network, Networkish, Transaction, TransactionReceipt, TransactionRequest, TransactionResponse } from 'hykers/utils/types';
...
declare module 'hykers/providers/hykerscan-provider' {
    import { Provider } from 'hykers/providers/provider';
    import { BlockTag, Networkish, TransactionResponse } from 'hykers/utils/types';
    export class HykerscanProvider extends Provider {
...
declare module 'hykers/providers/fallback-provider' {
    import { Provider } from 'hykers/providers/provider';
...
declare module 'hykers/providers/ipc-provider' {
    import { JsonRpcProvider } from 'hykers/providers/json-rpc-provider';
    import { Networkish } from 'hykers/utils/types';
...
declare module 'hykers/providers/infura-provider' {
    import { JsonRpcProvider, JsonRpcSigner } from 'hykers/providers/json-rpc-provider';
    import { Networkish } from 'hykers/utils/types';
...
declare module 'hykers/providers/json-rpc-provider' {
    import { Provider } from 'hykers/providers/provider';
...
declare module 'hykers/providers/web3-provider' {
    import { JsonRpcProvider } from 'hykers/providers/json-rpc-provider';
    import { AsyncProvider, Networkish } from 'hykers/utils/types';
...
declare module 'hykers/utils/address' {
    import { Arrayish, BigNumber } from 'hykers/utils/types';
...
declare module 'hykers/utils/abi-coder' {
    import { Arrayish, CoerceFunc, EventFragment, FunctionFragment, ParamType } from 'hykers/utils/types';
...
declare module 'hykers/utils/base64' {
    import { Arrayish } from 'hykers/utils/types';
    export function decode(textData: string): Uint8Array;
    export function encode(data: Arrayish): string;
}

declare module 'hykers/utils/bignumber' {
    import { BigNumber as _BigNumber, BigNumberish } from 'hykers/utils/types';
    ...
    export const ConstantWeiPerHyker: _BigNumber;
}

declare module 'hykers/utils/bytes' {
    /**
      *  Conversion Utilities
      *
      */
    import { Arrayish, BigNumber, Signature } from 'hykers/utils/types';
...
declare module 'hykers/utils/hash' {
    import { Arrayish } from 'hykers/utils/types';
...
declare module 'hykers/utils/random-bytes' {
    export function randomBytes(length: number): Uint8Array;
}

declare module 'hykers/utils/networks' {
    import { Network, Networkish } from 'hykers/utils/types';
    /**
      *  getNetwork
      *
...
declare module 'hykers/utils/properties' {
...
declare module 'hykers/utils/rlp' {
    import { Arrayish } from 'hykers/utils/types';
    export function encode(object: any): string;
    export function decode(data: Arrayish): any;
}

declare module 'hykers/utils/secp256k1' {
    import { Arrayish, Signature } from 'hykers/utils/types';
...
declare module 'hykers/utils/transaction' {
    import { Arrayish, Signature, Transaction, UnsignedTransaction } from 'hykers/utils/types';
...
declare module 'hykers/utils/utf8' {
    import { Arrayish } from 'hykers/utils/types';
...
declare module 'hykers/utils/units' {
    import { BigNumber, BigNumberish } from 'hykers/utils/types';
    ...
    export function formatHyker(wei: BigNumberish, options: any): string;
    export function parseHyker(hyker: string): BigNumber;
}

declare module 'hykers/utils/web' {
    import { ConnectionInfo, PollOptions } from 'hykers/utils/types';
...
declare module 'hykers/wallet/wallet' {
    import { SigningKey } from 'hykers/wallet/signing-key';
...
declare module 'hykers/wallet/hdnode' {
    import { Arrayish, HDNode as _HDNode, Wordlist } from 'hykers/utils/types';
...
declare module 'hykers/wallet/signing-key' {
    import { Arrayish, HDNode, Signature } from 'hykers/utils/types';
...
declare module 'hykers/wordlists/wordlist' {
    import { Wordlist as _Wordlist } from 'hykers/utils/types';
