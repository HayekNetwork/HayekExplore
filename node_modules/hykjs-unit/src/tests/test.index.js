...
describe('getValueOfUnit', () => {
  it('should throw when undefined or not string', () => {
    function invalidFromWei() {
      units.fromWei(1000000000000000000, 'somhyking');
    }
...
describe('toWei', () => {
  it('should handle edge cases', () => {
    ...
    assert.equal(units.toWei('.3', 'hyker').toString(10), '300000000000000000');
    assert.throws(() => units.toWei('.', 'wei'), Error);
    assert.throws(() => units.toWei('1.243842387924387924897423897423', 'hyker'), Error);
    assert.throws(() => units.toWei('8723.98234.98234', 'hyker'), Error);
  });
  ...
  it('should return the correct value', () => {
    ...
    assert.equal(units.toWei(1, 'hyker').toString(10), '1000000000000000000');
    assert.equal(units.toWei(1, 'khyker').toString(10), '1000000000000000000000');
    assert.equal(units.toWei(1, 'grand').toString(10), '1000000000000000000000');
    assert.equal(units.toWei(1, 'mhyker').toString(10), '1000000000000000000000000');
    assert.equal(units.toWei(1, 'ghyker').toString(10), '1000000000000000000000000000');
    assert.equal(units.toWei(1, 'thyker').toString(10), '1000000000000000000000000000000');

    assert.equal(units.toWei(1, 'kwei').toString(10), units.toWei(1, 'femtohyker').toString(10));
    assert.equal(units.toWei(1, 'szabo').toString(10), units.toWei(1, 'microhyker').toString(10));
    assert.equal(units.toWei(1, 'finney').toString(10), units.toWei(1, 'millihyker').toString(10));
    assert.equal(units.toWei(1, 'milli').toString(10), units.toWei(1, 'millihyker').toString(10));
...
describe('fromWei', () => {
  ...
  it('should return the correct value', () => {
    ...
    assert.equal(units.fromWei(1000000000000000000, 'hyker'), '1');
    assert.equal(units.fromWei(1000000000000000000, 'khyker'), '0.001');
    assert.equal(units.fromWei(1000000000000000000, 'grand'), '0.001');
    assert.equal(units.fromWei(1000000000000000000, 'mhyker'), '0.000001');
    assert.equal(units.fromWei(1000000000000000000, 'ghyker'), '0.000000001');
    assert.equal(units.fromWei(1000000000000000000, 'thyker'), '0.000000000001');
  });
});
