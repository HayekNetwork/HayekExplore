...
Method.prototype._confirmTransaction = function (defer, result, payload) {
    ...
    var _hayekchainCall = {};
    _.each(_hayekchainCalls, function (mthd) {
        mthd.attachToObject(_hayekchainCall);
    ...
    var checkConfirmation = function (existingReceipt, isPolling, err, blockHeader, sub) {
        if (!err) {
            ...
            return (existingReceipt ? promiEvent.resolve(existingReceipt) : _hayekchainCall.getTransactionReceipt(result))
            ...
            .then(function(receipt) {
                ...
                if (isContractDeployment && !promiseResolved) {
                    ...
                    _hayekchainCall.getCode(receipt.contractAddress, function (e, code) {
    ...
    var startWatching = function(existingReceipt) {
        ...
        if (_.isFunction(this.requestManager.provider.on)) {
            _hayekchainCall.subscribe('newBlockHeaders', checkConfirmation.bind(null, existingReceipt, false));
        } else {
    ...
    _hayekchainCall.getTransactionReceipt(result)
    .then(function(receipt) {
        if (receipt && receipt.blockHash) {
            if (defer.eventEmitter.listeners('confirmation').length > 0) {
...
Method.prototype.buildCall = function() {
    var method = this,
        isSendTx = (method.call === 'hyk_sendTransaction' || method.call === 'hyk_sendRawTransaction'); // || method.call === 'personal_sendTransaction'
    ...
    var send = function () {
        ...
        var sendRequest = function(payload, method) {
            ...
            if (method && method.accounts && method.accounts.wallet && method.accounts.wallet.length) {
                ...
                // HYK_SENDTRANSACTION
                if (payload.method === 'hyk_sendTransaction') {
                    ...
                    // HYK_SIGN
                } else if (payload.method === 'hyk_sign') {
