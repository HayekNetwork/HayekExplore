...
function setupMethods (soljson) {
  ...
  var copyToCString = function (str, ptr) {
    ...
    // See https://github.com/hayekchain/solidity/blob/v0.5.13/libsolc/libsolc.h#L37-L40
  ...
  return {
    ...
    loadRemoteVersion: function (versionString, cb) {
      ...
      var url = 'https://hayekchain.github.io/solc-bin/bin/soljson-' + versionString + '.js';
