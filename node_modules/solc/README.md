[![Build Status](https://img.shields.io/travis/hayekchain/solc-js.svg?branch=master&style=flat-square)](https://travis-ci.org/hayekchain/solc-js)
[![CircleCI](https://img.shields.io/circleci/project/github/hayekchain/solc-js/master.svg?style=flat-square)](https://circleci.com/gh/hayekchain/solc-js/tree/master)
[![Coverage Status](https://img.shields.io/coveralls/hayekchain/solc-js.svg?style=flat-square)](https://coveralls.io/r/hayekchain/solc-js)

# solc-js

JavaScript bindings for the [Solidity compiler](https://github.com/hayekchain/solidity).

Uses the Emscripten compiled Solidity found in the [solc-bin repository](https://github.com/hayekchain/solc-bin).
...
used in combination with an Hayekchain client via the `eth.compile.solidity()` RPC method. Please refer to the
...
<script
  ...
  src="https://solc-bin.hayekchain.org/bin/{{ SOLC VERSION }}.js"
></script>
```

(Alternatively use `https://solc-bin.hayekchain.org/bin/soljson-latest.js` to get the latests version.)
...
<script
  type="text/javascript"
  src="https://solc-bin.hayekchain.org/bin/list.js"
></script>
```
